...
app.post("/generate-quiz", async (req, res) => {
  ...
  console.log(module);
  const prompt = `Give me 3 mcq questions for each unit based on the text provided that will cover the entire content. Again make sure there are no additional characters in the response except for the MCQ questions and their answers too
